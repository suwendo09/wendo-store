...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="index.php">Keranjang Belanja</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="WendoStore2.php">Home</a></li>
                ...
                <form class="d-flex">
                    ...
                    <button class="btn btn-outline-light" type="submit" formaction="keranjang.php">
                        ...
                        <span class="badge bg-light text-black ms-1 rounded-pill"><?php echo count($_SESSION['keranjang']); ?></span>
                    </button>
                </form>
            </div>
        </div>
                ...
                <table class="table table-bordered text-center align-middle">
                    ...
                    if (isset($_SESSION['keranjang']) && is_array($_SESSION['keranjang'])): 
                        foreach ($_SESSION['keranjang'] as $id => $jumlah) {
                            $ambil = $koneksi->query("SELECT * FROM tb_produk WHERE id='$id'");
